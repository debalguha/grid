...
class ElasticSearch(config: ElasticSearchConfig, metrics: Option[ThrallMetrics]) extends ElasticSearchClient
  ...
  def bulkInsert(images: Seq[Image])(implicit ex: ExecutionContext, markerContext: MarkerContext): List[Future[ElasticSearchBulkUpdateResponse]] = {
    val request = bulk {
      images.map(img => {
  ...
  def indexImage(id: String, image: JsValue)(implicit ex: ExecutionContext, markerContext: MarkerContext): List[Future[ElasticSearchUpdateResponse]] = {
  ...
  def getImage(id: String)(implicit ex: ExecutionContext, markerContext: MarkerContext): Future[Option[Image]] = {
  ...
  def updateImageUsages(id: String, usages: Seq[Usage], lastModified: JsLookupResult)(implicit ex: ExecutionContext, markerContext: MarkerContext): List[Future[ElasticSearchUpdateResponse]] = {
  ...
  def updateImageSyndicationRights(id: String, rights: Option[SyndicationRights])(implicit ex: ExecutionContext, markerContext: MarkerContext): List[Future[ElasticSearchUpdateResponse]] = {
  ...
  def applyImageMetadataOverride(id: String, metadata: JsLookupResult, lastModified: JsLookupResult)(implicit ex: ExecutionContext, markerContext: MarkerContext): List[Future[ElasticSearchUpdateResponse]] = {
  ...
  def getInferredSyndicationRightsImages(photoshoot: Photoshoot, excludedImageId: Option[String])(implicit ex: ExecutionContext, markerContext: MarkerContext): Future[List[Image]] = { // TODO could be a Seq
  ...
  def getLatestSyndicationRights(photoshoot: Photoshoot, excludedImageId: Option[String] = None)(implicit ex: ExecutionContext, markerContext: MarkerContext): Future[Option[Image]] = {
  ...
  def deleteImage(id: String)(implicit ex: ExecutionContext, markerContext: MarkerContext): List[Future[ElasticSearchDeleteResponse]] = {
  ...
  def deleteAllImageUsages(id: String)(implicit ex: ExecutionContext, markerContext: MarkerContext): List[Future[ElasticSearchUpdateResponse]] = {
  ...
  def deleteSyndicationRights(id: String)(implicit ex: ExecutionContext, markerContext: MarkerContext): List[Future[ElasticSearchUpdateResponse]] = {
  ...
  def replaceImageLeases(id: String, leases: Seq[MediaLease])(implicit ex: ExecutionContext, markerContext: MarkerContext): List[Future[ElasticSearchUpdateResponse]] = {
  ...
  def addImageLease(id: String, lease: JsLookupResult, lastModified: JsLookupResult)(implicit ex: ExecutionContext, markerContext: MarkerContext): List[Future[ElasticSearchUpdateResponse]] = {
  ...
  def removeImageLease(id: String, leaseId: JsLookupResult, lastModified: JsLookupResult)(implicit ex: ExecutionContext, markerContext: MarkerContext): List[Future[ElasticSearchUpdateResponse]] = {
  ...
  def updateImageExports(id: String, exports: JsLookupResult)(implicit ex: ExecutionContext, markerContext: MarkerContext): List[Future[ElasticSearchUpdateResponse]] = {
  ...
  def deleteImageExports(id: String)(implicit ex: ExecutionContext, markerContext: MarkerContext): List[Future[ElasticSearchUpdateResponse]] = {
  ...
  def setImageCollection(id: String, collections: JsLookupResult)(implicit ex: ExecutionContext, markerContext: MarkerContext): List[Future[ElasticSearchUpdateResponse]] = { // TODO rename to setImageCollections
